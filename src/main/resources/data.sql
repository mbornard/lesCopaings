...
(default, 'Miralles', 'Lucas', 'lm@etud.univ-jfc.fr', 4.9, '2002-11-09'),--code 2
(default, 'Brignatz', 'Loris', 'lb@etud.univ-jfc.fr', 4.8, '2002-11-20'), --code 3
(default, 'Ntamack', 'Romain', 'ntk@etud.univ-jfc.fr', 4.8, '1999-05-01'); --code 4
